...
int main(int argc, char *argv[]) {
    ...
    //NOTA: se ci sarà un processo di lettura/scrittura da file all'esame, sarà con accesso casuale(realisticamente byte 128 o 156)
    //Realisticamente coinvolgerà l'uso del seek
