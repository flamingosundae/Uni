...
void *writer(void *arg) {
    while (TRUE) {
        ...
        up(&db);  // Rilascia accesso esclusivo
		  // Questo sistema ha il fondamentale problema di un potenziale blocco perpetuo dello scrittore.
		  // Potremmo dare priorità di coda agli scrittori(dopo i lettori attivi), riducendo la concorrenza, ma ha possibile impatto sulle prestazioni.
    }
}
