...
void read_command(char* cmd, char** args) {
    ...
    char* token = strtok(input, " \n"); // Dividiamo input su spazi e eventuali "\n" (alla fine della stringa)
					// Il processo di tokenizzazione consiste nel dividere una stringa in molteplici parti in base ad un dato criterio assegnato.
					// In questo caso, un nuovo token sarà creato per ogni volta che andiamo a capo.
